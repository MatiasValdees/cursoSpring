...
public class RedisConfig {
    ...
    public CacheManager cacheManager(RedissonClient redissonClient) {
        var configs = Map.of(
                Cache.FLY_CACHE_NAME, new CacheConfig(),
                Cache.HOTEL_CACHE_NAME, new CacheConfig()
        );
    ...
    @CacheEvict(cacheNames = {
            Cache.FLY_CACHE_NAME,
            Cache.HOTEL_CACHE_NAME
    },allEntries = true)
    //@Scheduled(cron = Cache.SCHEDULED_RESET_CACHE)
    @Async
